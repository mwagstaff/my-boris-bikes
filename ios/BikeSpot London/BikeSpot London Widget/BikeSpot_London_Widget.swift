...
struct BikeSpot_London_WidgetEntryView : View {
...
@main
struct BikeSpot_London_WidgetBundle: WidgetBundle {
...
struct BikeSpot_London_Widget: Widget {
    // This identifier is persisted by WidgetKit; keep it stable so existing widgets remain configured.
