...
//
//  Generated from fastlane's standard helper so `snapshot` can detect it.
//
...
enum SnapshotError: Error, CustomDebugStringConvertible {
    ...
    var debugDescription: String {
        ...
        case .cannotRunOnPhysicalDevice:
            return "Snapshot cannot run on a physical device."
        }
    }
}
...
open class Snapshot: NSObject {
    ...
    class func setLanguage(_ app: XCUIApplication) {
        guard let cacheDirectory = self.cacheDirectory else {
            NSLog("Cache directory is not set.")
            return
        }
    ...
    class func setLaunchArguments(_ app: XCUIApplication) {
        ...
        do {
            ...
            NSLog("Could not detect launch arguments.")
        }
    }
    ...
    open class func snapshot(_ name: String, timeWaitingForIdle timeout: TimeInterval = 20) {
        ...
        guard self.app != nil else {
            NSLog("XCUIApplication is not set. Call setupSnapshot(app) first.")
            return
        }
    ...
    class func waitForLoadingIndicatorToDisappear(within timeout: TimeInterval) {
        ...
        _ = XCTWaiter.wait(for: [disappeared], timeout: timeout)
    }
...
private extension XCUIElementQuery {
    ...
    var deviceStatusBars: XCUIElementQuery {
        guard let app = Snapshot.app else {
            fatalError("XCUIApplication is not set. Call setupSnapshot(app) first.")
        }
